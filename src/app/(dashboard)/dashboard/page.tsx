      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>You had 12 bookings this week</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Placeholder for a chart or table */}
            <div className="h-[200px] rounded-md border border-dashed flex items-center justify-center">
              <p className="text-muted-foreground">Booking history chart</p>
            </div>
          </CardContent>
        </Card>
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              You have 5 events scheduled for today
            </CardDescription>
          </CardHeader>
          <CardContent>
